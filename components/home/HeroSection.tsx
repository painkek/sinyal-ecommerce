      ...
      { /* centered content */ } 
        <div className="relative z-10 h-full flex flex-col justify-center text-white px-4 sm:px-6 md:px-8 lg:px-12">
          ...
          <div className={`mb-6 sm:mb-8 md:mb-12 ${gothicFont.className}`}>
            <h1 className="text-5xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold mb-2 sm:mb-4 
                          text-center sm:text-left 
                          sm:ml-0 md:ml-8 lg:ml-16">EMBODY</h1>
            <h1 className="text-5xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold mb-2 sm:mb-4 
                          text-center sm:text-left 
                          sm:ml-8 md:ml-24 lg:ml-48 xl:ml-72">YOUR</h1>
            <h1 className="text-5xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold 
                          text-center sm:text-left 
                          sm:ml-4 md:ml-16 lg:ml-32 xl:ml-50">JOURNEY</h1>
          </div>
